...
public abstract class VehicleInfoHelper
{
	...
	public static void insert (final org.omg.CORBA.Any any, final FleetManagement.VehicleInfo s)
	{
		any.type(type());
		write( any.create_output_stream(),s);
	}

	public static FleetManagement.VehicleInfo extract (final org.omg.CORBA.Any any)
	{
	...
	public static FleetManagement.VehicleInfo read (final org.omg.CORBA.portable.InputStream in)
	{
		FleetManagement.VehicleInfo result = new FleetManagement.VehicleInfo();
		result.vehicle_id=in.read_string();
		result.driver_name=in.read_string();
		result.position=FleetManagement.GeoPositionHelper.read(in);
		result.status=FleetManagement.VehicleStatusHelper.read(in);
		result.fuel_level_pct=in.read_float();
		result.odometer_km=in.read_ulong();
		return result;
	}
	public static void write (final org.omg.CORBA.portable.OutputStream out, final FleetManagement.VehicleInfo s)
	{
...
out.write_string( tmpResult1 );
		FleetManagement.GeoPositionHelper.write(out,s.position);
		FleetManagement.VehicleStatusHelper.write(out,s.status);
