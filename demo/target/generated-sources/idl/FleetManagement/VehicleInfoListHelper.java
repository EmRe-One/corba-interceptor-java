...
public abstract class VehicleInfoListHelper
{
	...
	public static void insert (org.omg.CORBA.Any any, FleetManagement.VehicleInfo[] s)
	{
		any.type (type ());
	...
	public static FleetManagement.VehicleInfo[] read (final org.omg.CORBA.portable.InputStream _in)
	{
		...
		_result = new FleetManagement.VehicleInfo[_l_result0];
		for (int i=0;i<_result.length;i++)
		{
			_result[i]=FleetManagement.VehicleInfoHelper.read(_in);
		}

		return _result;
	}

	public static void write (final org.omg.CORBA.portable.OutputStream _out, FleetManagement.VehicleInfo[] _s)
	{
		
		_out.write_long(_s.length);
		for (int i=0; i<_s.length;i++)
		{
			FleetManagement.VehicleInfoHelper.write(_out,_s[i]);
		}
