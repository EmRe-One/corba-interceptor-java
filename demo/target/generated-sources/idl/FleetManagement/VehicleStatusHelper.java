...
public abstract class VehicleStatusHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(VehicleStatusHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_enum_tc(FleetManagement.VehicleStatusHelper.id(),"VehicleStatus",new String[]{"MOVING","IDLE","PARKED","MAINTENANCE"});
				}
			}
		}
		return _type;
	...
	public static void insert (final org.omg.CORBA.Any any, final FleetManagement.VehicleStatus s)
	{
		any.type(type());
		write( any.create_output_stream(),s);
	}

	public static FleetManagement.VehicleStatus extract (final org.omg.CORBA.Any any)
	{
